...
def exportCSV(csvFile):
    csvFile.to_csv(r'C:\Users\Mateus\Desktop\Tratados\universidade_terminal.csv', index=None, header=True)
...
def main():
    ...
    # dictionary of lists
    dict = {'campus': campus_id, 'universidade': universidade_id, 'distancia': dist, 'terminal': terminal_id}
